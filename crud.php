...
if (isset($_POST['send'])) {
    ...
    $quantite_min = $_POST['stock-min'];
    $code_barre = $_POST['code-barre'];
    $offer_price = $_POST['offre_de_prix'];
    ...
    mysqli_query($data, "INSERT INTO product(name,old_price,new_price,image,stock,category,status,code_a_barres,offre_de_prix,quantite_min) VALUES ('$name', '$old_price','$new_price','$filename','$stock','$category','yes','$code_barre','$offer_price ','$quantite_min')");
...
ADD COLUMN quantite_min INT;
              ...
              <div>
                  <label for="item-weight" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">quantite min</label>
              ...
              <div>
                  <label for="item-weight" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">code barre</label>
              ...
              <div>
                  <label for="item-weight" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">offre price</label>
                  <input type="number" name = "offre_de_prix" placeholder = "offre price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="12" required="">
              </div> 
              <div class="sm:col-span-2">
